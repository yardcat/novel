...
const file_pb_world_proto_rawDesc = "" +
	"\n" +
	"\x0epb/world.proto\x12\x02pb\"0\n" +
	"\x10startCardRequest\x12\x1c\n" +
	"\tdifficuty\x18\x01 \x01(\tR\tdifficuty\"-\n" +
	"\x11startCardResponse\x12\x18\n" +
	"\achoices\x18\x01 \x03(\tR\achoices2A\n" +
	"\x05world\x128\n" +
	"\tstartCard\x12\x14.pb.startCardRequest\x1a\x15.pb.startCardResponseB\x06Z\x04./pbb\x06proto3"

var (
	file_pb_world_proto_rawDescOnce sync.Once
	file_pb_world_proto_rawDescData []byte
)

func file_pb_world_proto_rawDescGZIP() []byte {
	file_pb_world_proto_rawDescOnce.Do(func() {
		file_pb_world_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pb_world_proto_rawDesc), len(file_pb_world_proto_rawDesc)))
	})
	return file_pb_world_proto_rawDescData
}

var file_pb_world_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pb_world_proto_goTypes = []any{
...
func file_pb_world_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pb_world_proto_rawDesc), len(file_pb_world_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
